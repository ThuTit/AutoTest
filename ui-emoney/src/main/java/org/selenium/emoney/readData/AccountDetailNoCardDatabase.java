...
public class AccountDetailNoCardDatabase {
	 ...
	 * @param id_type
	 */
	public AccountDetailNoCardDatabase(
	 ...
	 * @return name
	 */
	public String getByArrayTypeRandom(fieldsNoCard col,int... type){
